...
runners.map(function(firstNameCap){
  ...
  return 
  allCaps.push(firstNameCap.first_name)
...
let runnersLargeSizeShirt = [];
  ...
  runners.filter(function(noShirts){
    if (noShirts.shirt_size === "L") {
      return runnersLargeSizeShirt.push(noShirts.first_name + ' ' + noShirts.last_name)
    }
  })
